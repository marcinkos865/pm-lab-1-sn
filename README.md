...
Odpowiedź:  Dioda się zaświeci

## Zadanie 2-2-2:
Pytanie:    *Czy zamienienie kolejności podłączenia diody LED i rezystora ma znaczenie?*  
Odpowiedź:  Nie ma znaczenia dopuki są połączone szeregowo.

## Zadanie 2-2-3:
Pytanie:    *Czy każdy rodzaj pętli jest wymienny (zawsze można zastąpić jedną konstrukcję drugą)?*  
Odpowiedź:  Wyłącznie przy zachowaniu warunków danego zadania.
...
Odpowiedź:  Program nie dostosowuje się do panującego ruchu na drodze.
